...
/*!**************************************************************************************!*\
  !*** external "accountMFE@https://kshitijraj09.github.io/account_mf/remoteEntry.js" ***!
  \**************************************************************************************/
...
module.exports = new Promise((resolve, reject) => {
	if(typeof accountMFE !== "undefined") return resolve();
	__webpack_require__.l("https://kshitijraj09.github.io/account_mf/remoteEntry.js", (event) => {
		if(typeof accountMFE !== "undefined") return resolve();
...
/***/ "webpack/container/reference/Messenger":
/*!******************************************************************************************!*\
  !*** external "messengerMFE@https://kshitijraj09.github.io/messenger_mf/remoteEntry.js" ***!
  \******************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var __webpack_error__ = new Error();
module.exports = new Promise((resolve, reject) => {
	if(typeof messengerMFE !== "undefined") return resolve();
	__webpack_require__.l("https://kshitijraj09.github.io/messenger_mf/remoteEntry.js", (event) => {
		if(typeof messengerMFE !== "undefined") return resolve();
		var errorType = event && (event.type === 'load' ? 'missing' : event.type);
		var realSrc = event && event.target && event.target.src;
		__webpack_error__.message = 'Loading script failed.\n(' + errorType + ': ' + realSrc + ')';
...
/*!************************************************************************************!*\
  !*** external "peopleMFE@https://kshitijraj09.github.io/people_mf/remoteEntry.js" ***!
  \************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var __webpack_error__ = new Error();
module.exports = new Promise((resolve, reject) => {
	if(typeof peopleMFE !== "undefined") return resolve();
	__webpack_require__.l("https://kshitijraj09.github.io/people_mf/remoteEntry.js", (event) => {
		if(typeof peopleMFE !== "undefined") return resolve();
		var errorType = event && (event.type === 'load' ? 'missing' : event.type);
		var realSrc = event && event.target && event.target.src;
		__webpack_error__.message = 'Loading script failed.\n(' + errorType + ': ' + realSrc + ')';
...
/***/ "webpack/container/reference/Post":
/*!********************************************************************************!*\
  !*** external "postMFE@https://kshitijraj09.github.io/post_mf/remoteEntry.js" ***!
  \********************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var __webpack_error__ = new Error();
module.exports = new Promise((resolve, reject) => {
	if(typeof postMFE !== "undefined") return resolve();
	__webpack_require__.l("https://kshitijraj09.github.io/post_mf/remoteEntry.js", (event) => {
		if(typeof postMFE !== "undefined") return resolve();
		var errorType = event && (event.type === 'load' ? 'missing' : event.type);
		var realSrc = event && event.target && event.target.src;
		__webpack_error__.message = 'Loading script failed.\n(' + errorType + ': ' + realSrc + ')';
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "root-application:";
...
/******/ 			],
/******/ 			"webpack_container_remote_People_People": [
/******/ 				"webpack/container/remote/People/People"
/******/ 			],
/******/ 			"webpack_container_remote_Messenger_Messenger": [
/******/ 				"webpack/container/remote/Messenger/Messenger"
/******/ 			],
/******/ 			"webpack_container_remote_Account_Account": [
/******/ 				"webpack/container/remote/Account/Account"
/******/ 			],
...
/******/ 			],
/******/ 			"webpack_container_remote_Post_Post": [
/******/ 				"webpack/container/remote/Post/Post"
/******/ 			]
/******/ 		};
...
/******/ 			};
/******/ 			var uniqueName = "root-application";
...
/******/ 					initExternal("webpack/container/reference/Post");
/******/ 				}
/******/ 				break;
/******/ 			}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkroot_application"] = self["webpackChunkroot_application"] || [];
